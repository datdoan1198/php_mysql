...
<body>
    ...
    <hr>
        <form action="category_add_producte.php" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="" placeholder="" name="parent_category">
            </div>
             <div class="form-group">
