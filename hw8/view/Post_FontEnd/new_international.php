...
<main role="main">
      ...
      <article>
        <header class="section background-dark">
          <div class="line">        
            <h1 class="text-white margin-top-bottom-40 text-size-60 text-line-height-1"><a href="">Home</a>->Sports->international News </h1>
          </div>  
        </header>
      </article>
      ...
      <section class="full-width padding-2x">  
          <div class="s-12 m-12 l-9 ">
            ...
            <?php foreach ($Post_international_time as $data) { ?>
      ...
      <section class="section-top-padding full-width padding-2x">
        ...
        <?php foreach ($Post_international_view as $data) { ?>
