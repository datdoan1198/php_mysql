...
<main role="main">
      ...
      <article>
        <header class="section background-dark">
          <div class="line">        
            <h1 class="text-white margin-top-bottom-40 text-size-60 text-line-height-1"><a href="">Home</a>->Medical->Covid-19</h1>
          </div>  
        </header>
      </article>
      ...
      <section class="full-width padding-2x">  
          <div class="s-12 m-12 l-9 ">
            ...
            <?php foreach ($Post_covid_19_time as $data) { ?>
            ...
            <div class="s-12 m-12 l-8">
                <div class="padding-2x">
                  <h3><a href="/hw8/index.php?mod=home&act=detail&id=<?php echo $data['id'] ?>"><?php echo $data['title']; ?></a></h3>
      ...
      <section class="section-top-padding full-width padding-2x">
        ...
        <?php foreach ($Post_covid_19_view as $data) { ?>
