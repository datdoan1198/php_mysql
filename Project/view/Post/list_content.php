                   ...
                   <?php foreach ($posts as $value) {   ?>
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-right">
                          <a class="btn btn-primary btn-sm" href="/hw8/index.php?mod=post&act=detail_content&id=<?php echo $value['id']; ?>">
                              <i class="fas fa-folder"></i>
                              View
                          </a>
                           <a class="btn btn-danger btn-sm" href="/hw8/index.php?mod=post&act=delete_content&id=<?php echo $value['id']; ?>">
